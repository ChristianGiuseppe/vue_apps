...
import useSorting from '../../hooks/sort.js';
...
export default {
  ...
  setup(props) {
    ...
    const { enteredSearchTerm, availableUsers, updateSearch } = useSearch(user, 'fullName');
    const { displayedUsers, sorting, sort } = useSorting(availableUsers, 'fullName');
