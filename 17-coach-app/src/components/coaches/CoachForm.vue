<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !description.isValid }">
            ...
            <p v-if="!description.isValid"> Descritpion must not be empty</p>
        </div>
        <div class="form-control" :class="{ invalid: !rate.isValid }">
            <label for="rate">Hourly Rate</label>
            <input type="number" id="rate" v-model.number="rate.val" />
            <p v-if="!rate.isValid"> Rate must not be greater than zero</p>
        </div>
        <div class="form-control" :class="{ invalid: !areas.isValid }">
            ...
            <p v-if="!areas.isValid">Must be selected one expertise</p>
        </div>
        <p v-if="!formIsValidate"> Please check field </p>
